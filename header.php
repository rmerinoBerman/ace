...
<html lang="en">
	<head>
		...
		<meta charset="UTF-8" />
		<title>Civic Builders 2014 Benefit</title>
		<?php wp_head(); ?>
		<link rel="stylesheet" href="<?php bloginfo( stylesheet_url ); ?>"/>

		
		<link rel="stylesheet" type="text/css" href="<?php echo PAGEDIR; ?>/styles/styles.min.css?<?php echo rand(0, 10000) . "=" . rand(0, 10000); ?>">
...
<!-- 		<link rel="stylesheet" type="text/less" href="<?php echo PAGEDIR; ?>/styles/styles.less"> 
 ...
 -->
		...
		<script type="text/javascript" src="<?php echo PAGEDIR; ?>/machines/libraries/validate/validate.js"></script>
		<link rel="stylesheet" type="text/css" href="<?php echo PAGEDIR; ?>/machines/libraries/shadowbox/shadowbox.css">
		<script type="text/javascript" src="<?php echo PAGEDIR; ?>/machines/libraries/shadowbox/shadowbox.js"></script>
	...
	<body data-tempdir="<?php echo PAGEDIR; ?>" id="<?php echo get_post( $post )->post_name; ?>">
		<?php
			...
			listPeople('json');
			listPeople_type('json');
			listSponsorships('json');
		?>
